            ...
            <header className="relative text-center py-24 sm:py-32 px-4 overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                        <button onClick={onLogin} className="px-8 py-3 bg-sky-600 hover:bg-sky-700 text-white font-semibold rounded-lg shadow-lg transition-transform transform hover:scale-105 border-none">
                            {t.getStarted}
                        </button>
                        <button onClick={onLogin} className="px-8 py-3 bg-slate-700 hover:bg-slate-600 text-white font-semibold rounded-lg transition-colors border-none">
                            {t.login}
                        </button>
                    </div>
                </div>
